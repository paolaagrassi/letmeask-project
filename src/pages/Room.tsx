...
export function Room() {
    ...
    async function HandleLikeQuestion(questionId: string, likeId: string | undefined) {
        if (likeId) {
            await database.ref(`rooms/${roomId}/questions/${questionId}/likes/${likeId}`).remove(); //remove like
        } else {
            await database.ref(`rooms/${roomId}/questions/${questionId}/likes`).push({ //add like
                authorId: user?.id,
            })
        }
